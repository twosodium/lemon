...
import 'update_profile_customer_model.dart';
export 'update_profile_customer_model.dart';

class UpdateProfileCustomerWidget extends StatefulWidget {
  const UpdateProfileCustomerWidget({super.key});

  @override
  State<UpdateProfileCustomerWidget> createState() =>
      _UpdateProfileCustomerWidgetState();
}

class _UpdateProfileCustomerWidgetState
    extends State<UpdateProfileCustomerWidget> {
  late UpdateProfileCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateProfileCustomerModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'UpdateProfile_customer'});
              ...
              child: ListView(
                ...
                children: [
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'UPDATE_PROFILE_CUSTOMER_Container_9lhgsm');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'UPDATE_PROFILE_CUSTOMER_UPDATE_BTN_ON_TA');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'UPDATE_PROFILE_CUSTOMER_RESET_PASSWORD_B');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'UPDATE_PROFILE_CUSTOMER_logOutButton_ON_');
