                    ...
                    children: [
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .passwordCTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ],
                              ),
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller:
                              _model.dropDownAccountTypeValueController ??=
                          ...
                          onChanged: (val) async {
                            safeSetState(
                                () => _model.dropDownAccountTypeValue = val);
                            logFirebaseEvent(
                                'SIGN_UP_DropDown-AccountType_ON_FORM_WID');
                          },
                          width: 200.0,
                          height: 40.0,
                          textStyle:
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            await UsersTable().insert({
                              'account-type': _model.dropDownAccountTypeValue,
                            ...
                            FFAppState().accountType =
                                _model.dropDownAccountTypeValue!;
                            if (FFAppState().accountType == 'Producer') {
                              logFirebaseEvent('Button_navigate_to');

                              context.pushNamedAuth(
                                  'farmer_mainpage', context.mounted);
                            } else if (FFAppState().accountType ==
                                'Business Customer') {
                              logFirebaseEvent('Button_navigate_to');

                              context.pushNamedAuth(
                                  'business_mainpage', context.mounted);
                            } else if (FFAppState().accountType ==
                                'Individual') {
                              logFirebaseEvent('Button_navigate_to');
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'SIGN_UP_PAGE_Text_zjtyhivy_ON_TAP');
